...
window.addEventListener('DOMContentLoaded', function () {
  ...
  submit.addEventListener('click', function () {
    ...
    axios.post("/proposes/".concat(messageable_id, "/messages"), {
  ...
  window.Echo["private"]("volunteer-match.".concat(messageable_id)).listen('MessageSend', function (e) {
...
function deleteMessage(e) {
  ...
  axios["delete"]("/proposes/".concat(messageable_id, "/messages/").concat(message_id));
  // メッセージのHTMLを削除する
  message_el.remove();
}
/******/ })()
