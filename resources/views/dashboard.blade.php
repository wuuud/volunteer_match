<x-app-layout>
                        ...
                        <li class="ml-4">
                            <a href="?is_published={{ $value }}"
                                class="hover:text-blue-500 
                                   @if (Request::get('is_published') === (string) $value || (Request::get('is_published') === null && App\Models\JobOffer::STATUS_OPEN == $value)) text-green-500 font-bold @endif
                               ">
                                {{ $name }}
                            </a>
                        </li>
    ...
    <div class="container mx-auto md:w-1/2 displya:flex w-1/2 my-8 px-4 py-4 grid gap-x-8 gap-y-4">
        ...
        {{-- <div class="flex flex-wrap -mx-1 lg:-mx-4 mb-4"> --}}
                <h4 class="text-gray-400 items-center text-sm">公開状況</h4>
                <ul class="flex">
