    ...
    <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen max-w-7xl mx-auto">
            ...
            <div class="relative flex items-center space-x-4">
                @can('volunteer')
                    <div class="relative">
                        ...
                        <span>NPO/NGO</span>
                        {{-- 企業アカウントの画像 --}}
                        <img src="{{ $propose->user->profile_photo_url }}" alt=""
                    ...
                    <div class="flex flex-col leading-tight">
                        ...
                        {{-- <span class="text-lg text-gray-600">{{  $propose->application->npo->volunteer->name }}</span> --}}
                    </div>
                @endcan
                @can('npo')
                    <div class="relative">
        ...
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0 sticky bottom-2">
            <div class="relative flex">
                ...
                <input type="hidden" id="messageable_id" name="messageable_id" value="{{ $propose->id }}">
